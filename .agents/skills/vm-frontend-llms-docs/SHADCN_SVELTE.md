...
This catalog was supplied by the user on 2026-05-10. Treat it as a routing index and verify official docs at `https://shadcn-svelte.com/docs` before relying on latest CLI, migration, registry, or component API behavior.
...
- [Radio Group](https://shadcn-svelte.com/docs/components/radio-group.md): A set of radio buttons where no more than one button can be checked at a time.
...
- [Tabs](https://shadcn-svelte.com/docs/components/tabs.md): A set of layered sections of content, known as tab panels, displayed one at a time.
...
- [Chart](https://shadcn-svelte.com/docs/components/chart.md): Charts built using LayerChart. Copy and paste into your apps.
- [Data Table](https://shadcn-svelte.com/docs/components/data-table.md): Powerful tables and datagrids built using TanStack Table.

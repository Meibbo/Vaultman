...
This catalog was supplied by the user on 2026-05-10. Treat it as a routing index and verify official docs at `https://bits-ui.com/docs` before relying on latest component API, migration, utility, or type-helper behavior.

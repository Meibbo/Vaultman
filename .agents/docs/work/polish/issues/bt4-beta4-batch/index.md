...
|---|---|---|---|
| BT4-001 | Toolbar tool-case collapse (regresión) | 01 | pending |
| BT4-002 | Tags explorer hang + memory leak (regresión) | 01 | pending |
| BT4-003 | Rail no se mueve al lane reservado (regresión) | 01 | pending |

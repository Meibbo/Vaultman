...
| [[002-sort-level|BT3-002]] | Sort level per-scope + parents-first interleave | AFK | completed (`ee7bc0f2`; re-diseño BT4-009) |
| [[003-addons-parity|BT3-003]] | Snippets/Plugins scene-precedent parity | AFK | completed (`5414a0f0`; reveal bug → BT4-004) |
| [[004-addon-cells|BT3-004]] | Addon cells: toggle nativo + gear config | AFK | completed (`d98d28e4`; orden/stale → BT4-006/007) |
...
| [[007-rail-lane|BT3-007]] | Rail lane = ancho track | AFK micro | completed (`03fe92bc`; rail→lane roto → BT4-003) |
| [[008-tab-labels-minimal|BT3-008]] | Tab labels en minimal + responsive searchbox | AFK | completed (`46243479`; toolbar collapse → BT4-001) |
| [[009-iconic-props-tags|BT3-009]] | Iconic change-icon en Props/Tags | AFK + research interno | completed parcial (`194a7306`; audit + hang → BT4-002/011) |

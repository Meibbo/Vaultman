...
- [ ] **Step 1: Expose a reactive per-id selection map without removing snapshots.**
...
- [ ] **Step 2: Stop cloning selection for table/grid.**
...
- [ ] **Step 3: Consume `selectedMap.get(id)` inside table/grid row scopes.**
...
- [ ] **Step 4: Time selection mutations.**

export const shortcutsTable: [string, string][] = [
	...
	['vm-node-table-row', 'hover:bg-[var(--background-modifier-hover)] transition-colors duration-100 cursor-pointer'],
	['vm-node-table-row-selected', 'bg-[var(--background-modifier-active-hover)]'],
	['vm-node-table-header-resizer', 'absolute right-0 top-0 bottom-0 w-1.5 cursor-col-resize hover:bg-[var(--interactive-accent)] transition-colors duration-150 z-30'],
];

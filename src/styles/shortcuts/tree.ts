export const shortcutsTree: [string, string][] = [
	['vm-tree-row', 'flex items-center gap-1.5 px-2 py-0.5 select-none cursor-pointer rounded-[var(--nav-item-radius,var(--radius-s))] transition-colors duration-100 text-[var(--text-normal)] hover:bg-[var(--nav-item-background-hover,var(--background-modifier-hover))]'],
	...
	['vm-toggle-chevron', 'transition-transform duration-200 text-[var(--text-muted)] hover:text-[var(--text-normal)] cursor-pointer'],

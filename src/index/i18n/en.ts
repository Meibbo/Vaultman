export const en: Record<string, string> = {
	...
	'settings.layout_theme.default': 'Default',
	'settings.layout_theme.polish': 'Polish',
	'settings.layout_theme.glass': 'Glass',
	'settings.layout_theme.custom': 'Create your own',
	...
	'settings.explorer_matched_filter_decorations': 'Matched filter node decorations',
	'settings.explorer_node_backgrounds': 'Node backgrounds',
	'settings.explorer_node_borders': 'Node borders',

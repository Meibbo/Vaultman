export const en: Record<string, string> = {
	...
	'settings.node_note_prefix_tag': 'Node-Note tag prefix',
	'settings.node_note_prefix_tag.desc': 'Prefix for tag bindings (default #). Changing it stages alias renames for review.',
	'settings.node_note_prefix_snippet': 'Node-Note snippet prefix',
	'settings.node_note_prefix_snippet.desc': 'Prefix for snippet bindings (default $). Changing it stages alias renames for review.',
	'settings.node_note_prefix_plugin': 'Node-Note plugin prefix',
	'settings.node_note_prefix_plugin.desc': 'Prefix for plugin bindings (default %). Changing it stages alias renames for review.',
	'settings.node_note_prefix_prop': 'Node-Note property prefix',
	'settings.node_note_prefix_prop.desc': 'Opening wrapper for property bindings (default [). Changing it stages alias renames for review.',
	'settings.node_note_prefix_prop_suffix': 'Node-Note property suffix',
	'settings.node_note_prefix_prop_suffix.desc': 'Closing wrapper for property bindings (default ]). Changing it stages alias renames for review.',

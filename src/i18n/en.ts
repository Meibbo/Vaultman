export const en: Record<string, string> = {
	...
	'prop.type.tags': 'Tags',
	'prop.type.aliases': 'Aliases',
	'prop.type.cssclasses': 'CSS classes',
	...
	'explorer.move_to_prop.rejected':
		'{property} is where this value already lives',
	...
	'settings.queue_warn_supersede': 'Warn when a queued operation is replaced',
	'settings.queue_warn_supersede.desc':
		'Queueing a second replacement of the same text replaces the first, since the first would leave the second nothing to match. This decides whether that is announced.',
	...
	'content.copy_option_list_style': 'List style',
	'content.copy_link_none': 'None',
	'content.copy_link_wikilink': 'Wikilink',
	'content.copy_link_markdown': 'Markdown',
	'content.copy_list_none': 'None',
	'content.copy_no_results': 'No results to copy.',

export const es: Record<string, string> = {
	...
	'settings.node_note_prefix_tag': 'Prefijo node-note para tags',
	'settings.node_note_prefix_tag.desc': 'Prefijo de bindings de tags (por defecto #). Cambiarlo prepara renames de alias para revisar.',
	'settings.node_note_prefix_snippet': 'Prefijo node-note para snippets',
	'settings.node_note_prefix_snippet.desc': 'Prefijo de bindings de snippets (por defecto $). Cambiarlo prepara renames de alias para revisar.',
	'settings.node_note_prefix_plugin': 'Prefijo node-note para plugins',
	'settings.node_note_prefix_plugin.desc': 'Prefijo de bindings de plugins (por defecto %). Cambiarlo prepara renames de alias para revisar.',
	'settings.node_note_prefix_prop': 'Prefijo node-note para props',
	'settings.node_note_prefix_prop.desc': 'Apertura del envoltorio de bindings de props (por defecto [). Cambiarlo prepara renames de alias para revisar.',
	'settings.node_note_prefix_prop_suffix': 'Sufijo node-note para props',
	'settings.node_note_prefix_prop_suffix.desc': 'Cierre del envoltorio de bindings de props (por defecto ]). Cambiarlo prepara renames de alias para revisar.',

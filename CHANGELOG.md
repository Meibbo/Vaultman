...
## [1.2.0](https://github.com/Meibbo/Vaultman/compare/1.1.6...1.2.0) (2026-06-23)
...
* achieved great stability and no more placeholders. ([e6c8019](https://github.com/Meibbo/Vaultman/commit/e6c8019e62a0ac6507a2425e48c14634f23b18f9))
* adapt tree grid row inputs ([161d494](https://github.com/Meibbo/Vaultman/commit/161d4940c47c157750dbe7543df3bc4fe6c84619))
* add dock fallback actions and drag payloads ([e374367](https://github.com/Meibbo/Vaultman/commit/e37436741a780368643ff64f34f6f1b295e595f0))
...
* add node table view for props and tags ([f75eed5](https://github.com/Meibbo/Vaultman/commit/f75eed51f04a9b3dc272fcedb0052442f3c35a8d))
...
* add resizable explorer tables and files grid ([2de4734](https://github.com/Meibbo/Vaultman/commit/2de4734f405f7c747859f6f5b37dbc9375a735a0))
...
* **cmenu:** add file open-mode actions (tab, split-right, window) ([b7a955f](https://github.com/Meibbo/Vaultman/commit/b7a955fb5e7731e6f6ab521fb586bb70054bf159))
* **commands:** focus existing search surfaces ([e1998cb](https://github.com/Meibbo/Vaultman/commit/e1998cb3d1deb1cc87e09053f2d5b16b0c9c5d23))
...
* **content:** reveal current file in results ([ab24176](https://github.com/Meibbo/Vaultman/commit/ab24176184761aaed19e54eaa9c17eab9ef13f42))
* **data:** close explorer parity wave ([9150c90](https://github.com/Meibbo/Vaultman/commit/9150c90e1008588a0df0b2d52bac741d8f433198))
...
* **files:** add parents first sort toggle ([6413463](https://github.com/Meibbo/Vaultman/commit/6413463501aae820271aceced2c9140098cfd388))
* **files:** expose cached word count cell ([aef7193](https://github.com/Meibbo/Vaultman/commit/aef7193dbe87695cc5dd0a4619d68db04ecbd477))
...
* incredible stability upgrade and no mre placeholders ([20cc403](https://github.com/Meibbo/Vaultman/commit/20cc40317da25c8e5fe4c9670c1f70f6e9806a1a))
...
* minimal style update ([2ff3794](https://github.com/Meibbo/Vaultman/commit/2ff37943f5bed28da526bf11cfef7e7ff0f22495))
...
* route statistics cards to data tabs ([46154f4](https://github.com/Meibbo/Vaultman/commit/46154f4da35563b2fe82fe5a10d942d16f00d39d))
...
* **settings:** configure badge cancel click mode ([f064626](https://github.com/Meibbo/Vaultman/commit/f064626dff86ff3d65e8760a0472e46f560d7a11))
* **settings:** gate explorer search highlights ([a7a41b4](https://github.com/Meibbo/Vaultman/commit/a7a41b473098b7e27f1012239269db270da82f7c))
...
* **sort:** show active sort-axis label on Props and Tags vert-col toggle ([18d7a8d](https://github.com/Meibbo/Vaultman/commit/18d7a8de32e58f0cdda97e0b4d567bb53b9af9c5))
...
* add nested flat explorer modes ([480e3ff](https://github.com/Meibbo/Vaultman/commit/480e3ff0907fc11de7cd926c40aa13d913d9a7af))
...
* align files table with bases layout ([5c0f8dc](https://github.com/Meibbo/Vaultman/commit/5c0f8dcdaf164a4e77c0b6ee14413896dfe93754))
...
* **ci:** update pinned GitHub Actions for 1.1.1 ([#23](https://github.com/Meibbo/Vaultman/issues/23)) ([93fd725](https://github.com/Meibbo/Vaultman/commit/93fd7251868648b50965da478ac367ae6d8abb69))
* clean explorer table scroll lifecycle ([571b618](https://github.com/Meibbo/Vaultman/commit/571b6180505850bc17975a47ee4a8b3ec18e8bf1))
...
* **commands:** focus active explorer search ([323eaa1](https://github.com/Meibbo/Vaultman/commit/323eaa1ef1ab1ac9e841d6808a6c1404c22bc713))
* **content:** clear search with filters ([fc40165](https://github.com/Meibbo/Vaultman/commit/fc40165886f2e22912f0ba329b797d7c51e8ac3f))
* **content:** preview header counts matched files while searching ([7f21d89](https://github.com/Meibbo/Vaultman/commit/7f21d894f874fb07a4decd9c29860e4dc78b2166))
* **content:** reconcile search within filtered scope ([6cb6dea](https://github.com/Meibbo/Vaultman/commit/6cb6deafa8ca4a150fab424dc17cabfc41eb09b5))
* **content:** respect filtered content scope ([99a099e](https://github.com/Meibbo/Vaultman/commit/99a099eb4bd0c4754a7fa39701ad60e1a782d638))
* **content:** unify search scope counters ([25156ee](https://github.com/Meibbo/Vaultman/commit/25156eeb9be389f3f7e5f2eda6193b7085ebd141))
* **context-menu:** expose minimal existing actions ([81550bc](https://github.com/Meibbo/Vaultman/commit/81550bc981a153dc6b1c9527ea09bbbda449d030))
...
* **css:** underline content find/replace inputs starting at placeholder ([3eb32b2](https://github.com/Meibbo/Vaultman/commit/3eb32b282be39a7f4abfc14361d8bb66bad22c94))
...
* **explorer:** align visual hierarchy badges ([350eabc](https://github.com/Meibbo/Vaultman/commit/350eabcbfc22197dcc8348c33c517b17443458c7))
* **files:** clarify prop count label ([6a6f2fa](https://github.com/Meibbo/Vaultman/commit/6a6f2faca46e5576042ff24b7349b8f5675eacd8))
* **files:** expose empty folders, folder create actions, and content filter launcher ([4a039c5](https://github.com/Meibbo/Vaultman/commit/4a039c52f206ce68c9f3f7940cb7831d9e23f508))
* **files:** expose type view filter ([aa86a05](https://github.com/Meibbo/Vaultman/commit/aa86a0573f45cef73d4d8760ffd381317f349b07))
* **files:** label prop counts as props ([65399c7](https://github.com/Meibbo/Vaultman/commit/65399c7b8be6e367fe46dd1eebcc41e9cfaa0c82))
...
* **files:** polish operation rename badges ([6b984bb](https://github.com/Meibbo/Vaultman/commit/6b984bb6a92c095b74116504656a6c97fffe99a4))
* **files:** prevent sort bridge reactive loop ([d188c84](https://github.com/Meibbo/Vaultman/commit/d188c8466afcee7d5ae946d4c3605a9dc857fb09))
* **files:** sort flat tree by file rows ([169f268](https://github.com/Meibbo/Vaultman/commit/169f26852c0f674e61cb27f775c4fd86e4468646))
* **files:** suppress default folder noise ([a494410](https://github.com/Meibbo/Vaultman/commit/a49441080d7d0e8bdb985bf0a393372cbef9bfbc))
* **files:** tighten view menu and type grouping ([a898194](https://github.com/Meibbo/Vaultman/commit/a898194c0bae0ffec76272f6ac7a7fa2d0fa9857))
* **files:** validate property rename patterns ([19aed5f](https://github.com/Meibbo/Vaultman/commit/19aed5fe7669e774e1f6ad3c260ffb14a0846db7))
* **filters:** active-filters counter shows filtered/vault-total ([bb1d3df](https://github.com/Meibbo/Vaultman/commit/bb1d3df7d956051faa871ba91889d1aa63b9620c))
* **filters:** count view filters in content scope ([5b6b956](https://github.com/Meibbo/Vaultman/commit/5b6b9566aaa6fe4318a51d0c0671407ed6b30b43))
* **filters:** island counter reflects visible file count when view filter active ([53a5661](https://github.com/Meibbo/Vaultman/commit/53a5661a2c7e3f0ec1e19e1d5c2707a9239c484c))
* **filters:** repair 1.1.2 scope labels and sorting ([6c09667](https://github.com/Meibbo/Vaultman/commit/6c09667a18b70f041512959c77a3802b57be729c))
...
* **lint:** type openPopoutLeaf access instead of any cast ([b0c0e82](https://github.com/Meibbo/Vaultman/commit/b0c0e823137660cc2bbbc26ab2c4b1d607febda1))
...
* **mobile:** align navbar and nested guides ([d99a493](https://github.com/Meibbo/Vaultman/commit/d99a493a7b8af002128ca25fa5ed988620c70a90))
...
* **queue:** project folder delete affected files ([4fcea98](https://github.com/Meibbo/Vaultman/commit/4fcea98a7f7020a56f6c75679888d4334c22e14b))
...
* repair explorer sort and statistics scopes ([363ce23](https://github.com/Meibbo/Vaultman/commit/363ce23651e1b9072dba0588590fabcd8fe6ab6b))
...
* **scorecard:** narrow file drag payloads ([559b8d0](https://github.com/Meibbo/Vaultman/commit/559b8d0104275a9e60a42cfc074e0a6a5ef82ce1))
* **scorecard:** remove CSS lint warnings ([6b49f8c](https://github.com/Meibbo/Vaultman/commit/6b49f8c30d73938aa8d56e408d90173e09d5f8d5))
* **search:** stabilize explorer highlights ([1100b39](https://github.com/Meibbo/Vaultman/commit/1100b390879a60ede3c542fd9f4591a360e9b518))
* **search:** stabilize highlight rendering ([d67599b](https://github.com/Meibbo/Vaultman/commit/d67599b0f52716c65e22d44bd62dc338f9ec7e79))
* **security:** remove codeql dead guard and add policy ([6fbcdcd](https://github.com/Meibbo/Vaultman/commit/6fbcdcd14018995b71d510c18e6007f929d897da))
...
* **sort:** natural numeric sort for files, folders, and filter service ([1247b18](https://github.com/Meibbo/Vaultman/commit/1247b1818b541c6076a96cdbe017cbaff0e63331))
* stabilize data tabs and queue guards ([a011380](https://github.com/Meibbo/Vaultman/commit/a011380ab1e2c0eba1ff2df787ba17aaf3806a36))
* **stable:** activate explorer controls and dock actions ([bb3935b](https://github.com/Meibbo/Vaultman/commit/bb3935b02e4aeb9084d9ba94bdb652cd31556fc1))
* **stable:** align explorers with core parity ([f4d9a97](https://github.com/Meibbo/Vaultman/commit/f4d9a97bfb1131b7379dd5d8947e537fde1fc89e))
* **stable:** remove inert controls and refresh settings UI ([4508707](https://github.com/Meibbo/Vaultman/commit/45087070d7a095040e92834e2c1be0fa1468ed18))
* **stable:** restore explorer parity and reactive stats ([b325f86](https://github.com/Meibbo/Vaultman/commit/b325f861ab94b0c3e7ad0e86b48f96c72afde96f))
* **statistics:** keep stale word counts visible ([3181dcb](https://github.com/Meibbo/Vaultman/commit/3181dcb7df0f9c4b09b9daa1283a472770545efa))
* surface zero-result filters and content tab label ([3741a36](https://github.com/Meibbo/Vaultman/commit/3741a361fefab3eb432bc7ca3a11e48513912c38))
...
* **tags:** show parent tags with direct occurrences in simple mode ([78956f3](https://github.com/Meibbo/Vaultman/commit/78956f3da792879ba6a433141b9fc7f8012c6990))
* **tags:** temporarily remove send-inline-to-frontmatter from context menu ([0ad2e11](https://github.com/Meibbo/Vaultman/commit/0ad2e11d7b29b5e0b58ad7a9152a0da9c9b5482e))
* **tree:** restore native caret geometry ([e53343e](https://github.com/Meibbo/Vaultman/commit/e53343e95493384ec3cd1b655f1110a1e6acb61c))
* **tree:** restore nested indent and expand motion ([a8a2410](https://github.com/Meibbo/Vaultman/commit/a8a2410a377457b9c3b9f6a20e94962182499909))
* **ui:** default operation badges to monotone ([8772e59](https://github.com/Meibbo/Vaultman/commit/8772e59f95abe99601fe639b6142e0fca5ad9387))
...
* **words:** refresh Words cell in near-real time as files are edited ([ce88eeb](https://github.com/Meibbo/Vaultman/commit/ce88eebcad491c497ecee55d8a1fff7ce915df29))
* **words:** skip binary files; match Obsidian word count with Unicode regex ([b4a97d9](https://github.com/Meibbo/Vaultman/commit/b4a97d9ae5f054a33785edd7ef65218794bb2853))
...
* narrow active filter evaluation ([52125b3](https://github.com/Meibbo/Vaultman/commit/52125b3526d8991298492185dd11c604f70356de))
* reuse virtual explorer rows ([078ca04](https://github.com/Meibbo/Vaultman/commit/078ca04f354c43aad01c21784115a2b18a28b816))
...
* **words:** patch Words cell in place; refresh on save not per-parse ([8831d96](https://github.com/Meibbo/Vaultman/commit/8831d962e9148912b5c089acc78e7fd0228bf405))

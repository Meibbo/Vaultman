...
/**
 * AC#1 import-boundary guard for the Q4 logic-extraction.
 *
 ...
 * `src/logic/logicFiles.ts` and assert no module in that graph imports `obsidian`
...
describe('logicFiles import boundary (AC#1)', () => {
	const entry = resolve(srcRoot, 'logic/logicFiles.ts');

	it('logicFiles.ts exists', () => {
